    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                <div className="bg-green-100 text-green-600 rounded-full p-3 font-bold text-lg min-w-[3rem] text-center">1</div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-green-100 text-green-600 rounded-full p-3 font-bold text-lg min-w-[3rem] text-center">2</div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-green-100 text-green-600 rounded-full p-3 font-bold text-lg min-w-[3rem] text-center">3</div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-green-100 text-green-600 rounded-full p-3 font-bold text-lg min-w-[3rem] text-center">4</div>
                <div>
      ...
      <div className="py-16 bg-green-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <Sprout className="h-16 w-16 text-green-100 mx-auto mb-6" />
